...
const ProjectSlider = () => {
  ...
  return (
    <section id="featured-work" className="project-slider-section">
      <div className="container">
        ...
        <div className="slider-header">
          ...
          <h2>Selected Projects Showcase</h2>
          <p className="section-subtitle">
            Interactive showcase of my recent design and development projects
          </p>
        </div>
